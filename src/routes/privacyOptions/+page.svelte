...
<MiniNav />
<main class="flex flex-col gap-4 p-10 text-left w-2/3">
    ...
    <p class="my-4">If you're a US user and want to opt out of such data sharing, you can do so by pressing the button below.</p>
    <button class="btn variant-filled w-40">I want to opt put</button>
    <p>You can read more about how we use your personal information in our <a href="">Privacy Policy.</a> </p>
</main>
<Footer />
