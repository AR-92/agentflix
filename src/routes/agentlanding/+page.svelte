<div class="pb-20 px-10">
	<div class="flex px-4 font-semibold justify-between">
		<img class="m-8" style="width: 150px" src="./Agentflix.svg" alt="" srcset="" />
		<!-- <ul class="flex m-auto gap-8">
			<li>Solutions</li>
			<li>Resources</li>
			<li>Why Us</li>
			<li>Pricing</li>
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		...
		<div class="col-span-5 bg-gray-200" style="height: 500px;" />
	</div>
	<div class="grid grid-cols-12 gap-x-16 gap-y-6 mx-8 my-12">
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		<div class="col-span-7">
			<div class="text-5xl mt-10 font-semibold">
	...
	<div class="grid grid-cols-12 gap-x-16 gap-y-6 mx-8 my-12 text-center">
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		<div class="col-span-7">
			<div class="text-5xl mt-10 font-semibold">Empower your brokerage and expand the team</div>
			<p class="mt-16">
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		...
		<div class="col-span-9 bg-gray-200" style="height: 500px;" />
	</div>
	<div class="grid grid-cols-12 gap-x-16 gap-y-6 mx-8 my-12">
		<div class="col-span-3 bg-gray-200 h-20" />
		<div class="col-span-3 bg-gray-200 h-20" />
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		<div class="col-span-7">
			<div class="text-5xl mt-10 font-semibold">Take your career to a new level</div>
			<p class="mt-16">
				...
				marketing methods of real estate and connects clients with agents easier.
			</p>
		</div>
	</div>
	<div class="grid grid-cols-12 gap-x-16 gap-y-6 mx-8 my-12">
	...
	<div class="grid grid-cols-12 gap-4 m-8 h-full">
		<div class="col-span-7">
			<div class="text-5xl mt-10 font-semibold">Smart and efficient automation</div>
			<p class="mt-16">
...
<!-- <div class="grid grid-cols-12 gap-x-16 gap-y-6 my-12 text-center text-gray-500 card text-sm">
	<div class="col-span-3 m-8 p-4">
		<img class="m-8" style="width: 120px" src="./Agentflix.png" alt="" srcset="" />
		<p>© 2023 Agentflix.</p>
	...
	<div class="col-span-3 m-8 p-4">
		<div class="text-lg font-bold mb-10">Get in Touch</div>
		<p class="">Moonshine St. 14/05 Light City, London, United Kingdom</p>
		<p>info@email.com</p>
		<p>00 (123) 456 78 90</p>
	</div>
	<div class="col-span-3 m-8 p-4">
		<div class="text-lg font-bold mb-10">Learn More</div>
	...
	<div class="col-span-3 m-8 p-4">
		<div class="text-lg font-bold mb-10">Join Us</div>
		<p class="">Subscribe to our newsletter to get our news & deals delivered to you.</p>
...
<div class="card text-sm text-left">
	<div class="grid grid-cols-12 gap-x-16 gap-y-6 my-12 mx-20 text-gray-500">
