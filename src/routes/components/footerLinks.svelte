<!-- 
<div class="px-20 grid grid-cols-4 my-20 gap-10 text-sm">
    <ul class="flex flex-col gap-y-2">
        <li class="font-medium mb-4">Support</li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Help Center</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">AirCover</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Supporting people with disabilities</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Cancellation options</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Our COVID-19 Response</a></li>
    </ul>
    <ul class="flex flex-col gap-y-2">
        <li class="font-medium mb-4">Community</li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Airbnb.org: disaster relief housing</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Combating discrimination</a></li>
    </ul>
    <ul class="flex flex-col gap-y-2">
        <li class="font-medium mb-4">Hosting</li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Airbnb your home</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">AirCover for Hosts</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Explore hosting resources</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Visit our community forum</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">How to host responsibly</a></li>
    </ul>
    <ul class="flex flex-col gap-y-2">
        <li class="font-medium mb-4">Agentflix</li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Newsroom</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Learn about new features</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Letter from our founders</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Careers</a></li>
        <li><a href="./" class="hover:underline underline-offset-1 hover:text-primary-500">Investors</a></li>
    </ul>
</div> -->
<script>
...
<div class="grid grid-cols-12 gap-x-16 gap-y-6 my-4 mx-20 hover:text-gray-900 dark:hover:text-white dark:text-primary-100">
    <div class="col-span-6 m-4 p-4">
        <!-- <img style="width: 120px" src="./Agentflix.svg" alt="" srcset="" /> -->
        <svg
		on:click={() => {
			goto('./');
		}}
   ...
   -98 -170 -108 -186 l-18 -30 -113 183 -112 184 -243 3 -243 2 20 -32z"
        ...
        <p class="mt-1">
            Explore Agentflix and grow your professional career. Enjoy a simpler and smarter platform
        ...
        <ul class="flex mt-5 space-x-5">
            <li>
                <a
                    href="./"
                    class="text-primary-500 hover:text-gray-900 dark:hover:text-white dark:text-primary-100"
                >
    ...
    <div class="col-span-3 m-4 p-4">
        <div class="text-lg font-bold mb-6">Always know what you pay</div>
    ...
    <div class="col-span-3 m-4 p-4">
        ...
        <ul class="flex flex-col gap-y-2">
            ...
            <li class="hover:text-primary-500 dark:hover:text-primary-300 cursor-pointer">Site Map</li>
            <li class="hover:text-primary-500 dark:hover:text-primary-300 cursor-pointer">Terms of Use</li>
            <li class="hover:text-primary-500 dark:hover:text-primary-300 cursor-pointer">Privacy Policy</li>
        </ul>
    </div>
</div>