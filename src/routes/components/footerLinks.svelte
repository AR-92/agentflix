...
<div
	class="grid grid-cols-12 gap-x-16 gap-y-6 my-4 mx-20 hover:text-gray-900 dark:hover:text-white dark:text-primary-100"
>
   ...
   -98 -170 -108 -186 l-18 -30 -113 183 -112 184 -243 3 -243 2 20 -32z"
		...
		<p class="mt-1">
			...
			next house. A smarter platform designed for you and inspired from social media apps we all use
			to give you a connected feel.
		</p>
