<script>
	...
	import { TabGroup, Tab, Avatar, FileDropzone ,Stepper, Step} from '@skeletonlabs/skeleton';
...
<Model bind:show bind:closeable={closeable}  width="w-1/2 max-lg:w-1/2 font-bitten">
...
<Model bind:show={showAdvance} bind:closeable={closeable} width="w-1/2 max-lg:w-1/2 font-bitten">
	<div slot="body">
		<div class="p-4 flex h-fit">
            <div class="p-4">
                <Stepper
